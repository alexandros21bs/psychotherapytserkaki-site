...
export default function Contact() {
  ...
  const address = isEnglish ? siteData.addressEn : siteData.address
  ...
  function handleSubmit(e) {
    ...
    const subject = encodeURIComponent(
      isEnglish ? `Contact request from ${form.name}` : `Αίτημα επικοινωνίας από ${form.name}`,
    )
    ...
    try {
      ...
      setStatusMessage(t.contactEmailFallback)
    }
  }
        ...
        <div className="container contact-grid">
          ...
          <div className="contact-info">
            ...
            <div className="contact-detail">
              ...
              <p><a href={`mailto:${primaryRecipient}`}>{primaryRecipient}</a></p>
            </div>
