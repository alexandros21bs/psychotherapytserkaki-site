        ...
        <div className="container about-grid">
          ...
          <div className="about-content">
            ...
            <p>
              ...
              και εργάζομαι με ενήλικες, ζευγάρια και οικογένειες, μέσα σε
              ένα πλαίσιο εμπιστοσύνης, σεβασμού και ουσιαστικής συνεργασίας.
            </p>

            <p>
              Πιστεύω πως κάθε άνθρωπος κουβαλά τη δική του μοναδική ιστορία,
              τις εμπειρίες, τις δυσκολίες αλλά και τις δυνατότητές του. Για
              μένα, η θεραπευτική διαδικασία δεν αφορά την παροχή έτοιμων
              απαντήσεων, αλλά τη δημιουργία ενός ασφαλούς χώρου, όπου μπορεί
              κανείς να ακουστεί πραγματικά, να κατανοήσει βαθύτερα τον
              εαυτό του και να προχωρήσει με περισσότερη επίγνωση και
              σταθερότητα.
            </p>

            <p>
              Στόχος μου είναι να προσφέρω ένα περιβάλλον όπου ο άνθρωπος
              μπορεί να εκφραστεί χωρίς φόβο κριτικής, να επεξεργαστεί όσα
              τον απασχολούν και να ανακαλύψει, με τον δικό του ρυθμό, πιο
