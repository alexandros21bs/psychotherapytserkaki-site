export const googleReviewsMeta = {
  ...
  total: '40+',
  profileUrl:
    'https://www.google.com/search?q=%CE%91%CE%B4%CE%B1%CE%BC%CE%B1%CE%BD%CF%84%CE%AF%CE%B1+%CE%A4%CF%83%CE%B5%CF%81%CE%BA%CE%AC%CE%BA%CE%B7+%CF%88%CF%85%CF%87%CE%BF%CE%B8%CE%B5%CF%81%CE%B1%CF%80%CE%B5%CE%AF%CE%B1+%CE%A7%CE%B1%CE%BD%CE%B9%CE%AC',
  writeReviewUrl:
    'https://g.page/r/Ce6WceMpdVW8EBM/review',
}
